...
| pathogen_strain_id        | Pathogen strain ID                 | string  | The NCBI Taxonomy identifier at the strain level for each strain of the pathogen. Multiple values are delimited with a semicolon.                                                                                                                            |
